...
const ProductPageCounter = dynamic(() => import("@/components/ProductPages/ProductPageCounter"));
const Fintechparnters = dynamic(() => import("@/components/ProductPages/Fintechparnters"));
const PricingSection = dynamic(() => import("@/components/PricingSection"));
const Testimonial = dynamic(() => import("@/components/Testimonial"));
const DistinctiveModels = dynamic(() => import("@/components/ProductPages/DistinctiveModels"));
const Bulidimpact = dynamic(() => import("@/components/ProductPages/Bulidimpact"));
const Commissionmanagement = dynamic(() => import("@/components/ProductPages/Commissionmanagement"));
...
const ProcessFlow = dynamic(() => import("@/components/ProductPages/ProcessFlow"));
const AboutBanner = dynamic(() => import("@/components/AboutUS/AboutBanner"));
const TimelineSlider = dynamic(() => import("@/components/AboutUS/TimelineSlider"));
...
export const getServerSideProps = async (ctx: GetServerSidePropsContext) => {
  ...
  if (slug === "career-detail") {
    ...
    const res = await fetch(`${BASE_URL}/api/services/?filters[slug]=${slug}&populate=deep`);
